...
ParticleSystem::ParticleSystem(const Vector3& g) {
	...
	generateSpring();
	generateElasticBand();
	generateAnchoredSpring();
	generateBuoyancyGenerator();
...
void ParticleSystem::generateSpring() {	
	Particle* p1 = new Particle({50, 20, 5}, {0, 0, 0}, {0, 0, 0}, 0.998, 100, 1, 1, {255, 255, 0, 1}, false);
	_springParticle = new Particle({ 70, 20, 5 }, { 0, 0, 0 }, { 0, 0, 0 }, 0.998, 100, 1, 1, { 255, 0, 0, 1 }, false);
...
void ParticleSystem::generateElasticBand() {
	_elasticBandParticle = new Particle({ 50, 20, -5 }, { 0, 0, 0 }, { 0, 0, 0 }, 0.998, 100, 1, 1, { 255, 0, 0, 1 }, false);
	Particle* p2 = new Particle({ 70, 20, -5 }, { 0, 0, 0 }, { 0, 0, 0 }, 0.998, 100, 1, 1, { 255, 255, 0, 1 }, false);
...
void ParticleSystem::generateAnchoredSpring() {
	_anchoredSpringParticle = new Particle({-55, 20, 0 }, { 0, 0, 0 }, { 0, 0, 0 }, 0.998, 100, 1, 1, { 255, 0, 0, 1 }, false);
...
void ParticleSystem::generateBuoyancyGenerator() {
	_buoyancyParticle = new Particle({ 0, 7, 0 }, { 0, 0, 0 }, { 0, 0, 0 }, 0.90, 100, 400, { 2, 5, 2 }, { 255, 0, 0, 1 }, false);
	Particle* pB2 = new Particle({ -15, 7, 0 }, { 0, 0, 0 }, { 0, 0, 0 }, 0.90, 100, 200, { 5, 10, 5 }, { 255, 255, 0, 1 }, false);
	Particle* pB3 = new Particle({ 15, 7, 0 }, { 0, 0, 0 }, { 0, 0, 0 }, 0.90, 100, 400, { 1, 3, 1 }, { 255, 255, 0, 1 }, false);
