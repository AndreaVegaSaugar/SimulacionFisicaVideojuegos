...
SolidRigidSystem::SolidRigidSystem(PxScene* scene, PxPhysics* physics) {
	_zone.x_Max = 500; _zone.x_Min = -500; _zone.y_Max = 500; _zone.y_Min = -50; _zone.z_Max = 500; _zone.z_Min = -500;
	this->scene = scene;
	...
	_solidRigid_generators.push_back(new GaussianSolidRigidGenerator(this->scene, physics, "chuloGaussian", { 20, 0.01, 5 }, { 0.01, 5, 0.01 }, { 50, 50, 0 }, { 0.01, -15, 0.01 }, 1));
